...
class BackBone_tvr(nn.Module):
    def __init__(self, config):
        super(BackBone_tvr, self).__init__()
    ...
    def forward(self, text_ids, text_mask, video, video_mask=None):
        ...
        if self.training:
            ...
            M_t2v_logits, M_v2t_logits = self.get_similarity_logits(text_feat, cls, video_feat, text_mask, video_mask)
            sim_loss = (self.loss_fct(M_t2v_logits * logit_scale) + self.loss_fct(M_v2t_logits * logit_scale)) / 2.0
            loss = sim_loss
    ...
    def get_similarity_logits(self, text_feat, cls, video_feat, text_mask, video_mask):
        ...
        return _retrieve_logits, _retrieve_logits.T
    ...
    def get_text_feat(self, text_ids, text_mask, shaped=False):
        ...
        cls, text_feat = self.clip.encode_text(text_ids, return_hidden=True)
