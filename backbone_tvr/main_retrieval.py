...
from tvr.models.modeling import BackBone_tvr, AllGather
...
def get_args(description='text to video retrieval based on the DRL'):
    ...
    parser.add_argument('--anno_path', type=str, default='../data/MSRVTT/msrvtt_data', help='annotation path')
    parser.add_argument('--video_path', type=str, default='../data/MSRVTT/MSRVTT/videos/all', help='video path')
    ...
    parser.add_argument('--batch_size_val', type=int, default=24, help='batch size eval')
    ...
    parser.add_argument("--output_dir", default='ckpts/ckpt_msrvtt', type=str, required=True, help="The output directory where the model predictions and checkpoints will be written.")
